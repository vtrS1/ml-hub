...
export class AdsController {
  ...
  updatePrice = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const sellerId = this.getSellerId(req);
      const id = String(req.params['id']);
  ...
  pause = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const sellerId = this.getSellerId(req);
      const id = String(req.params['id']);
  ...
  sync = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    try {
      const sellerId = this.getSellerId(req);
